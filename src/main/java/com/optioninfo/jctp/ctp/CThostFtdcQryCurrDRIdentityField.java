...
public class CThostFtdcQryCurrDRIdentityField {
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        ThostTradeApiJNI.delete_CThostFtdcQryCurrDRIdentityField(swigCPtr);
      }
      swigCPtr = 0;
    }
  }
  ...
  public void setDRIdentityID(int value) {
    ThostTradeApiJNI.CThostFtdcQryCurrDRIdentityField_DRIdentityID_set(swigCPtr, this, value);
  }

  public int getDRIdentityID() {
    return ThostTradeApiJNI.CThostFtdcQryCurrDRIdentityField_DRIdentityID_get(swigCPtr, this);
  }
