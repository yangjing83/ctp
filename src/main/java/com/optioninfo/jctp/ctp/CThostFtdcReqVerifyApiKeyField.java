...
public class CThostFtdcReqVerifyApiKeyField {
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        ThostTradeApiJNI.delete_CThostFtdcReqVerifyApiKeyField(swigCPtr);
      }
      swigCPtr = 0;
    }
  }
  ...
  public void setApiHandshakeDataLen(int value) {
    ThostTradeApiJNI.CThostFtdcReqVerifyApiKeyField_ApiHandshakeDataLen_set(swigCPtr, this, value);
  }

  public int getApiHandshakeDataLen() {
    return ThostTradeApiJNI.CThostFtdcReqVerifyApiKeyField_ApiHandshakeDataLen_get(swigCPtr, this);
  }

  public void setApiHandshakeData(String value) {
    ThostTradeApiJNI.CThostFtdcReqVerifyApiKeyField_ApiHandshakeData_set(swigCPtr, this, value);
  }

  public String getApiHandshakeData() {
    return ThostTradeApiJNI.CThostFtdcReqVerifyApiKeyField_ApiHandshakeData_get(swigCPtr, this);
  }
